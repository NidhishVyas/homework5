...
def test_get_history(setup_calculations):
    ...
    assert (
        len(history) == 2
    ), "History does not contain the expected number of calculations"
...
def test_get_latest(setup_calculations):
    ...
    assert latest.a == Decimal("20") and latest.b == Decimal(
        "3"
